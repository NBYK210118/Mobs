    ...
    <div className="border-b border-slate-500">
      ...
      {[...Array(4)].map((_, idx) => (
        ...
        >
          ...
          <span className="text-sm whitespace-nowrap font-semibold">이용 관련</span>
          <span className="max-w-36 text-sm whitespace-nowrap font-semibold truncate">이게 맞냐?</span>
      ...
      {[...Array(4)].map((_, idx) => (
        ...
        >
          <span className="text-sm whitespace-nowrap font-semibold">1234</span>
          <span className="text-sm whitespace-nowrap font-semibold">유저 신고</span>
          <span className="max-w-36 text-sm whitespace-nowrap font-semibold truncate">
            UserName21 신고합니다asdadasdasss
          </span>
          <span className="text-sm whitespace-nowrap font-semibold">ㅁㄴㅇㄻㄴ</span>
          <span className="text-xs text-gray-500 font-semibold">2024-06-24 10:32</span>
          <div className="flex gap-1 mr-3">
